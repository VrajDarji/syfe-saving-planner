        ...
        {exchangeRate ? (
          <>
            <div className="flex justify-between items-center mb-8">
              ...
              <button
                className="flex items-center gap-2 py-1 px-3 md:py-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors duration-200 cursor-pointer"
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-white/70 text-sm">
                    $
                    {(
                      (overviewData.target || 0) / exchangeRate
                    ).toLocaleString()}
                  </div>
                </div>
              </div>
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-white/70 text-sm">
                    $
                    {(
                      (overviewData.saved || 0) / exchangeRate
                    ).toLocaleString()}
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col md:flex-row justify-between pt-3 md:items-center text-sm text-white/70 border-t-[1px] border-white/70">
